...
<!--               			내용을 설정했을때 -->
			...
			<div class="home_contents">
			    <div class="photo_contents" style="height: 520px; width: 538px;">
		            <form method="post" id="frm" action="photoModify" enctype="multipart/form-data" style="color: black;">
		            	<input type="hidden" name=photoId value="${photoView.photoId}">
...
<%-- 			                <input type="hidden" value="<%=request.getRealPath("/") %>" name="photoPath"> --%>
			            ...
			            <div class="select_img"><img id="previewImage" src="/display?fileName=${photoView.photoPath}" style="height: 276px; width: 420px;"/></div>
			        </div>
			            <div class="photo_write_form">
			                <label for="photoTitle">제목</label>
			                <input type="text" id="photoTitle" name="photoTitle" style="width: 486px;" value="${photoView.photoTitle}">
			            </div>
			            <div class="photo_write_form">
			                <label for="photoCont">내용</label>
			                <textarea id="photoCont" name="photoCont" rows="10" style="width: 486px; height: 322px; resize: none; font-family: 'Nanum Gothic', sans-serif;" >${photoView.photoCont}</textarea>
			            </div>
			            <div align="center">
