              ...
              <div class="home_contents">
                ...
                <div class="updated_news_contents">
                  <div class="updated_news_left">
                  	...
                  	<c:if test="${newList.type eq 'diary'}">
	                    <span class="updated_news_left1"><a href="diary"><span class="updated_news_red">&nbsp;다이어리&nbsp;</span>${newList.diaryTitle}</a></span>
                  	</c:if>
                  	<c:if test="${newList.type eq 'photo'}">
                    	<span class="updated_news_left1"><a href="photo"><span class="updated_news_red3">&nbsp;사진첩&nbsp;</span>${newList.photoTitle}</a></span>
                  	</c:if>
                  	</c:forEach>
                  </div>
                  <div class="updated_news_right">
                   <div class="updated_news_right1"><a href="diary">다이어리 <span class="updated_news_right_number">${todayDiary}/${totalDiary}
	                   <c:if test="${todayDiary > 0 }">
	                   		&nbsp;<span class="updated_news_red2">&nbsp;N&nbsp;</span>
	                   </c:if>
                   </a></span> &emsp;&emsp;&emsp;&emsp;사진첩 <span class="updated_news_right_number">${todayPhoto}/${totalPhoto}
           				<c:if test="${todayPhoto > 0 }">
	                   		&nbsp;<span class="updated_news_red2">&nbsp;N&nbsp;</span>
	                   </c:if></span></div>
                    <div class="updated_news_right2"><a href="visit">방명록 <span class="updated_news_right_number">${todayVisit}/${totalVisit}
                    	<c:if test="${todayVisit > 0 }">
	                   		&nbsp;<span class="updated_news_red2">&nbsp;N&nbsp;</span>
	                   </c:if>
                    </a></span></div>
                ...
                <div class="miniroom_contents">
		           	<c:choose>
						<c:when test="${mainDto.id == 'yeju'}">
		                  <img class="miniroom_gif" src="https://i.imgur.com/mB2o1SY.png">
						</c:when>
						<c:otherwise>
		                  <img class="miniroom_gif" src="https://i.imgur.com/Q4gpMGR.png">
						</c:otherwise>
					</c:choose>
<!--                   <img class="miniroom_gif" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ3HY5Wik2jzt6PJ_hC3fmfg3JkAqSQmoeyMVA-ucuKofMk6xN5YKM3Il6T4I8vD1PslA&usqp=CAU"> -->
                </div>
              </div>
<!--    범위 ---------------------------------------------------------------------------------------------------  -->
            </div>
