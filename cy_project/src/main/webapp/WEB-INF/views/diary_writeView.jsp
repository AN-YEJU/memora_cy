...
<!--               	본인 페이지에만 수정버튼 -->
               ...
               <div class="home_contents">
                <form action="diaryWrite" method="post" id="frm">
                  <div class="diary_write_form">
                    <label for="diaryTitle">제목</label>
                    <input type="text" id="diaryTitle" name="diaryTitle" style="width: 518px;">
                  </div>
                  <div class="diary_write_form">
                    <label for="diaryCont">내용</label>
                    <textarea id="diaryCont" name="diaryCont" rows="10" style="width: 519px; height: 322px; resize: none; font-family: 'Nanum Gothic', sans-serif;" ></textarea>
                  </div>
				<div align="center">
